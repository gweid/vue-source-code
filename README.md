...
-   主要作用：把生成的 VNode 渲染, 在 core/instance/lifecycle.js 中定义
-   核心方法 patch
...
-   当我们通过 createComponent 创建了组件 VNode，接下来会到 vm.\_update ，执行 vm.**patch** 去把 VNode 转换成真正的 DOM 节点。

#### 2-2、组件的 patch

-   调用 createElm 创建元素节点 （定义在 core/vdom/patch.js）
